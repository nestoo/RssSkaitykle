 ...
 */
public class KmeansUncommonWords implements java.io.Serializable {
	...
	public KmeansUncommonWords() {
	}

	public KmeansUncommonWords(Integer articleId, Integer centroid) {
